...
// place custom function at /landing_page/assets/js/custom.js
// --------------------------------------------------
      ...
      submitHandler: function(form) {
        $(form).ajaxSubmit({
          ...
          success: function(data) {
            ...
            $formNotify.removeClass('valid error').addClass('valid').html('<i class="fa fa-check"></i> Email sent!').show();
          },
          error: function(data) {
...
// --------------------------------------------------
  ...
  function fn_siteBgSlideshow() {
    ...
    for (var i = 1; i <= _bg_slideshow_image_amount; i++) {
      $siteBgImg.append('<img src="/landing_page/assets/img/bg/site-bg-slideshow-' + (i < 10 ? '0' + i : i) + '.jpg">');
    }
...
// --------------------------------------------------
  ...
  function fn_siteBgVideo() {
    ...
    $video.append('<video id="bgVideo" autoplay loop>' +
                  '<source src="/landing_page/assets/video/video.mp4" type="video/mp4">' +
                  '</video>');
  ...
  function fn_siteBgAudio() {
    if (_bg_style_mobile == 1 || _bg_style_mobile == 3 || _bg_style_mobile == 5 || _bg_style_mobile == 7 || _bg_style_desktop == 1 || _bg_style_desktop == 3 || _bg_style_desktop == 5 || _bg_style_desktop == 7 || _bg_style_desktop == 10 || _bg_style_desktop == 13) {
      $body.append('<audio id="audioPlayer" loop>' +
                   '<source src="/landing_page/assets/audio/audio.mp3" type="audio/mpeg">' +
                   '</audio>');
    }
